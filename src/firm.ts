/* ================= DỮ LIỆU CỐ ĐỊNH CỦA HÃNG ================= */
/*
 * Tách khỏi src/data.ts có chủ đích. data.ts còn re-export toàn bộ kho bài viết,
 * tin tức và văn bản pháp luật; header với phần đầu trang chỉ cần vài hằng số ở
 * đây. Nếu chúng cùng import qua data.ts thì bundler kéo luôn ~200 kB nội dung
 * vào chunk tải đầu, dù nội dung đó chỉ hiển thị trong Home2 vốn đã lazy-load.
 */
